...
function getAiExtractionPrompt() {
  return [
    ...
    'Vá»›i giáº¥y chá»©ng nháº­n quyá»n sá»­ dá»¥ng Ä‘áº¥t, bÃ³c tÃ¡ch tÃªn giáº¥y chá»©ng nháº­n vÃ o certificate_title vÃ  chuáº©n hÃ³a má»™t trong cÃ¡c tÃªn: "Giáº¥y chá»©ng nháº­n quyá»n sá»­ dá»¥ng Ä‘áº¥t"; "Giáº¥y chá»©ng nháº­n quyá»n sá»­ dá»¥ng Ä‘áº¥t, quyá»n sá»Ÿ há»¯u nhÃ  á»Ÿ vÃ  tÃ i sáº£n khÃ¡c gáº¯n liá»n vá»›i Ä‘áº¥t"; "Giáº¥y chá»©ng nháº­n quyá»n sá»­ dá»¥ng Ä‘áº¥t, quyá»n sá»Ÿ há»¯u tÃ i sáº£n gáº¯n liá»n vá»›i Ä‘áº¥t".',
