...
function getAiExtractionPrompt() {
  return [
    ...
    'Voi ngay cap CCCD/Can cuoc, chi trich id_issue_date khi OCR doc ro ngay gan nhan "Ngay, thang, nam / Date, month, year" hoac "Ngay, thang, nam cap / Date of issue" theo dinh dang dd/MM/yyyy, dd-MM-yyyy, dd.MM.yyyy hoac ddMMyyyy toan so. Khong duoc tu suy luan tu OCR hong nhu "Oro712021". Neu full-image OCR khong ro, he thong phai dung crop chuyen biet: CCCD cu crop hep sau anchor year/yea; Can cuoc moi crop vung ben duoi Date of issue. Khong dung OpenAI Vision/toan anh lam nguon quyet dinh doc lap cho ngay cap.',
