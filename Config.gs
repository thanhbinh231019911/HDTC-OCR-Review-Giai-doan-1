...
function getAiExtractionPrompt() {
  return [
    ...
    'Voi giay chung nhan quyen su dung dat, boc tach dung ten giay chung nhan theo OCR/bia dat vao assets[].certificate_title, khong hard-code va khong ep ve mot danh sach ten co dinh. Ten co the la "Giay chung nhan quyen su dung dat" hoac co them "quyen so huu nha o va tai san khac gan lien voi dat" hoac ten khac; neu OCR ro thi giu du cum ten do, chi sua loi OCR chinh ta ro rang nhu "hwuux"/"hwux"/"huux" thanh "hữu".',
