...
- Khong duoc tu suy luan ngay cap tu OCR hong/bien dang nhu `Oro712021`, `Or0712021` thanh mot ngay cu the. Neu OCR khong doc ro ngay dang `dd/MM/yyyy`, `dd-MM-yyyy`, `dd.MM.yyyy` hoac `ddMMyyyy` toan so ngay canh nhan ngay cap, phai dung OpenAI Vision doc truc tiep anh mat sau; neu Vision khong doc chac thi de trong/canh bao sua tay.
